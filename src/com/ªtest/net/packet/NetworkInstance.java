...
//	private final IEventBus networkEventBus;
	...
	NetworkInstance(String channelName, Supplier<String> networkProtocolVersion, Predicate<String> clientAcceptedVersions, Predicate<String> serverAcceptedVersions) {
