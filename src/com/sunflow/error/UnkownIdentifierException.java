...
public class UnkownIdentifierException extends ReadMessageException {
	 ...
	 */
	public UnkownIdentifierException() { super(); }
	 ...
	 *            and indicates that the cause is nonexistent or unknown.)
	 */
	public UnkownIdentifierException(Throwable cause) {
		super(cause);
	}
}
